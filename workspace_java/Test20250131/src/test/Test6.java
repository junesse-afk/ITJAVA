...
//     calculFn("abacabcd",-1,seen) => return "" 
        ...
        // 19번
        node a19 = new node(10) ;
        node b19 = new node(20) ;
        node c19 = new node(30) ;
        
        node head = a19;
        a19.n2 = b19;
        b19.n2 = c19;
        
        System.out.println(head.n2.n1);
        // 결과 20
        
        //20번
        String str20 = "ITISTESTSTRING";
        String[] result20 = str20.split("T");
        for(String s : result20) {
        	System.out.print(s + " ");
        }
        System.out.println();
        System.out.println(result20[3]);
	}
